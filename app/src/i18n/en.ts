...
export const en: Dict = {
  ...
  stage: {
    ...
    pets: 'Pets',
    size: 'Pet size',
    sizeDesc: 'Up to 120% in the taskbar, up to 300% in the floating window',
    sizeClip: 'Above 100% the tallest effects (words, smoke) may be cut off by the top of the taskbar',
